  ...
  forwardRef3(
    ({
      ...
      return /* @__PURE__ */ jsx7("button", {
        ...
        ...props,
        children: loading ? /* @__PURE__ */ jsx7(Spinner, {
...
import { useEffect as H, useState as j2 } from "react";
...
var Toast = memo9(({ ...props }) => {
  return /* @__PURE__ */ jsx8(Ie, {
...
var showToast = ({ children, ...props }) => _t.custom((t2) => /* @__PURE__ */ jsx9(Alert, {
  "aria-live": "assertive",
  "aria-atomic": "true",
